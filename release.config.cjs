 ...
 *
 * ВНИМАНИЕ: ветка здесь 'main', а не 'master'. В react-native-nitro-xray-core
 * стоит 'master', и дословное копирование в репозиторий с 'main' привело бы
 * к тому, что semantic-release молча не выпускает ничего.
 */
module.exports = {
